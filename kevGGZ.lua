...
function SendNotification(text)
    Notification:Notify(
        {Title = "kevGGZ", Description = "coolest kid - "..text},
...
TextButton.Text = "kevGGZ"
TextButton.TextColor3 = Color3.fromRGB(0, 0, 0)
TextButton.TextScaled = true
TextButton.TextSize = 30
TextButton.TextStrokeColor3 = Color3.fromRGB(0,0,139)
...
KevMyLittleNigga = Sections.Visuals.AC:Dropdown(
        {
        Name = "Walk",
        Options = {
        "Nothing",
...
task.spawn(function()
    ...
    watermark:Update { "kevGGZ", ScriptProperties.UserPanel.Status, frames .. " FPS", string.format("%s:%s %s", tonumber(os.date("%I")), os.date("%M"), os.date("%p")) }
